...
parser.add_argument('--data_statistics', type=str,
                    default="/home/xiaoyefan/projects/VPS-main/lib/dataloader/statistics.pth", help='The normalization statistics.')
parser.add_argument('--dataset', type=str,
                    default="TrainDataset")
parser.add_argument('--dataset_root', type=str,
                    default="/home/xiaoyefan/projects/VPS-main/data/SUN-SEG-Annotation")
